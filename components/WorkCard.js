...
export const WorkCard = () => {
  ...
  return (
    <div className="p-4 w-full max-w-xl bg-white rounded-lg border-2 sm:p-6 dark:bg-black dark:border-gray-800">
      <div className="flex items-center mb-4">
        <WorkIcon w={25} h={25} fill={theme === 'dark' ? 'rgba(255,255,255)' : 'rgba(0,0,0,0.3)'} />
        <h5 className="ml-3 text-xl font-bold leading-none text-gray-900 dark:text-white">Work</h5>
      </div>
          ...
          <li className="py-3 sm:py-4">
            <div className="flex items-center justify-between space-x-4 space-y-2">
              <div className="flex space-x-4 space-y-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-gray-900 truncate dark:text-white">Slotly</p>
                  <p className="text-sm text-gray-500 truncate dark:text-gray-400">
                    Fullstack Developer
                  </p>
                </div>
          ...
          <li className="">
            <div className="flex items-center justify-between space-x-4 space-y-2">
              <div className="flex space-x-4 space-y-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-gray-900 truncate dark:text-white">BlackX</p>
                  <p className="text-sm text-gray-500 truncate dark:text-gray-400">
                    Frontend Developer
                  </p>
                </div>
