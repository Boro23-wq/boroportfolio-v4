const projectsData = [
  ...
  },
  {
    ...
    description: `Interface for visualizing pathfinding algorithms. Implemented - A*
    Search, Dijkstra, Breadth First Search, and Depth First Search.`,
    imgSrc: '/static/images/time-machine.jpg',
    href: 'https://algo-vz.netlify.app/',
  },
  {
    title: 'Gizmo',
    description: `MERN stack, customized eCommerce application for electronics.
    Fully-featured shopping cart integration using Paypal API.`,
    imgSrc: '/static/images/time-machine.jpg',
